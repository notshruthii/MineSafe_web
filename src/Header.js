...
import Navbar from './Navbar'; // Make sure this file exists and exports a React component
import Navbar1 from './components/Navbar1'; // Make sure this file exists and exports a React component

const generateMonthlyAttendance = () => {
  const months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  return months.map(month => ({
    month,
    attendance: parseFloat((Math.random()).toFixed(2)), // random between 0 and 1 with 2 decimals
  }));
};
